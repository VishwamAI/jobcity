...
const JavaBasicExamination: React.FC = () => {
  const tasks: Task[] = [
    ...
    },
    {
      ...
      description: "Create a Java program that calculates and prints the sum of two integers entered by the user."
    },
    {
      title: "Task 3: Largest of Three Numbers",
      description: "Develop a Java program that finds and displays the largest among three numbers input by the user."
    }
  ];

  const hints: Hint[] = [
    { text: "Remember to include the 'public static void main(String[] args)' method in your Java programs." },
    { text: "Use 'System.out.println()' for output in Java." },
    { text: "To get user input, you can use 'Scanner' class from 'java.util' package." },
    { text: "For Task 2, declare two integer variables to store user input." },
    { text: "In Task 3, use if-else statements or Math.max() function for comparisons." }
  ];
            ...
            <div className="border-4 border-dashed border-gray-200 rounded-lg p-4">
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-lg p-4">
                <p className="text-gray-700 mb-4">
                  Welcome to the Java Basic Examination. Here you will find various
                  tasks to test your basic Java programming skills.
                </p>
