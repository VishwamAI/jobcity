  ...
  const tasks: Task[] = [
    {
      ...
      description: "Write a Golang program that prints \"Hello, World!\" to the console."
    },
    {
      title: "Task 2: Sum of Two Integers",
      description: "Create a Golang program that calculates and prints the sum of two integers entered by the user."
    },
    {
      title: "Task 3: Largest of Three Numbers",
      description: "Develop a Golang program that finds and displays the largest among three numbers input by the user."
    }
  ];

  const hints: Hint[] = [
    { text: "Use the 'fmt' package for input/output operations in Golang." },
    { text: "The 'fmt.Println()' function is used for printing to the console." },
    { text: "To get user input, you can use 'fmt.Scan()' or 'fmt.Scanf()'." },
    { text: "Remember to declare variables with their types in Golang." },
    { text: "Use if-else statements for comparisons in the third task." }
  ];
