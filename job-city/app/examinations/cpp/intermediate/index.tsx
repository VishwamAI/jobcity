              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-lg p-4">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Implement a class for a binary search tree with insertion, deletion, and traversal methods.
                  </p>
                  ...
                  <div className="mt-4">
                    ...
                    <ul className="list-disc pl-5 text-sm text-gray-600">
                      <li>Remember to handle both left and right child nodes</li>
                      <li>Consider implementing helper methods for recursive operations</li>
                    </ul>
                  </div>
