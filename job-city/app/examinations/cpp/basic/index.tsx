...
const CPPBasicExamination: React.FC = () => {
  ...
  const hints: Hint[] = [
    { text: "Include the <iostream> header for input/output operations." },
    { text: "Use std::cout for output and std::cin for input." },
    { text: "For Task 2, declare two integer variables to store user input." },
    { text: "In Task 3, use if-else statements or the std::max function for comparisons." }
  ];
            ...
            <div className="border-4 border-dashed border-gray-200 rounded-lg p-4">
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-lg p-4">
                <p className="text-gray-700 mb-4">
                  Welcome to the C++ Basic Examination. Here you will find various
