        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link href="#" className="text-gray-600 hover:text-indigo-600 transition duration-150">About Us</Link>
              <Link href="#" className="text-gray-600 hover:text-indigo-600 transition duration-150">Contact</Link>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4">
              ...
              <Link href="#" className="block py-2 text-gray-600 hover:text-indigo-600">About Us</Link>
              <Link href="#" className="block py-2 text-gray-600 hover:text-indigo-600">Contact</Link>
            </div>
          )}
        </nav>
      </header>
